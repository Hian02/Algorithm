...
<table>
  ...
  <tr>
    <td>플랫폼</td>
    <td>프로그래머스, 백준, SWEA, LeetCode, codeforces 등</td>
  </tr>
  <tr>
    <td>언어</td>
...
4. 정기 스터디에서 꼭 한 문제씩 발표 맡기.
5. 정기 스터디 날까지 차주 주제에 맞는 문제 하나씩 찾아서 추천하기.
...
```
-알고리즘
주 3~5문제 (easy 2문제, normal 2문제, hard 1문제 중 3개 필수! 가능하면 5개)
주 1회 모임 : 문제 풀이 피드백
